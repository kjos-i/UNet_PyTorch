...
1. Make sure to have a separate test dataset. Arrange your training dataset (training and validation combined) like this: 
   ...
   <img width="150" height="104" alt="Skjermbilde 2025-11-07 203630" src="https://github.com/user-attachments/assets/bc13a00d-c9f6-48e9-92b9-e4bf5317411a" />
...
<img width="360" height="194" alt="Skjermbilde 2025-11-07 213123" src="https://github.com/user-attachments/assets/1ad221b3-15d9-45e2-813f-2218b8f8c08e" />
...
## Test run result examples

![Validation example: input image with predicted mask](images/image_mask_val_196_0.png)

![Training loss, IoU, Dice, and accuracy over epochs](images/training_loss_iou_dice_acc_graph.png)
